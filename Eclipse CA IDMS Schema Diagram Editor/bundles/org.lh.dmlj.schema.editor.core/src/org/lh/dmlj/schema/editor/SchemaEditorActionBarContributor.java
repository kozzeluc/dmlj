...
public class SchemaEditorActionBarContributor extends ActionBarContributor {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		// we should consider to move the zoom in and out actions to the toolbar and eliminate the Diagram menu altogether	
		super.contributeToMenu(menuManager);
		
		var diagramMenu = menuManager.findMenuUsingPath(DIAGRAM_MENU_ID);		
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {	
		...
		var zoomStrings = new String[] { ZoomManager.FIT_ALL, ZoomManager.FIT_HEIGHT, ZoomManager.FIT_WIDTH };
