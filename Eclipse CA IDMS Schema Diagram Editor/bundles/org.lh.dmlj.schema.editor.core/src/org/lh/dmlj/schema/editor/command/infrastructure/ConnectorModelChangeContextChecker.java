...
public final class ConnectorModelChangeContextChecker extends ModelChangeContextChecker<Connector> {

	@Override
	public boolean appliesTo(ModelChangeContext context, Connector connector) {
		...
		var connectionPartIndex = memberRole.getConnectionParts().indexOf(connector.getConnectionPart());
