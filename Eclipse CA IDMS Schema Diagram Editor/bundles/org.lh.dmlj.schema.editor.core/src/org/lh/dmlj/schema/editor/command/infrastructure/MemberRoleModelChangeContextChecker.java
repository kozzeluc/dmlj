...
public final class MemberRoleModelChangeContextChecker extends ModelChangeContextChecker<MemberRole> {

	@Override
	public boolean appliesTo(ModelChangeContext context, MemberRole memberRole) {
		...
		return contextData.size() == 2 &&
				...
				schemaRecord.getName().equals(contextData.get(ContextDataKeys.RECORD_NAME)) || contextData.size() == 3 &&
