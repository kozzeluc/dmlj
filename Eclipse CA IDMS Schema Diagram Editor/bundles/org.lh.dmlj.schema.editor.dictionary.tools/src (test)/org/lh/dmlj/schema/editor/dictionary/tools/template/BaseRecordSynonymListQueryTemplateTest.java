...
public class BaseRecordSynonymListQueryTemplateTest extends AbstractQueryTestCase {
	...
	public void test_10_rowids_grouped_by_3() {		
		...
		assertEquals(toLines(new File("testdata/ExpectedBaseRecordSynonymListQuery_10_3.txt")), toLines(sql));		
	}
	...
	public void test_1_rowid_grouped_by_3() {		
		...
		Dictionary dictionary = getDictionary("SYSDICT", 3);
		String sql = template.generate(new Object[] {dictionary, rowidProviders});		
		assertEquals(toLines(new File("testdata/ExpectedBaseRecordSynonymListQuery_1_3.txt")), toLines(sql));		
	}	
