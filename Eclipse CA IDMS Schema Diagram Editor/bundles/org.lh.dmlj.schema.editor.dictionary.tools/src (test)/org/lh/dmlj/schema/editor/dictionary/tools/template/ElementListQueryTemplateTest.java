...
public class ElementListQueryTemplateTest extends AbstractQueryTestCase {
	...
	public void test_10_rowids_grouped_by_3() {		
		...
		assertEquals(toLines(new File("testdata/ExpectedElementListQuery_10_3.txt")), toLines(sql));		
	}
	
	@Test
	public void test_10_rowids_grouped_by_3_no_page_information_in_rowids() {		
		List<IRowidProvider> rowidProviders = getRowidProviders(10, false);		
		Dictionary dictionary = getDictionary("SYSDICT", 3);
		String sql = template.generate(new Object[] {dictionary, rowidProviders});		
		assertEquals(toLines(new File("testdata/ExpectedElementListQuery_10_3_no_page_information_in_rowids.txt")), toLines(sql));		
	}
	...
	public void test_1_rowid_grouped_by_3() {		
		...
		Dictionary dictionary = getDictionary("SYSDICT", 3);
		String sql = template.generate(new Object[] {dictionary, rowidProviders});		
		assertEquals(toLines(new File("testdata/ExpectedElementListQuery_1_3.txt")), toLines(sql));		
	}
