...
public class JdbcToolsTest {
	...
	@Test
	public void testGetSplitQueryRowidListEmptyList() {
	...
	@Test
	public void testSingleByteToBooleanArrayAllFalse() {
		var expected = new boolean[] { false, false, false, false, false, false, false, false };
		var result = JdbcTools.toBooleanArray(new byte[] { 0 });
		assertArrayEquals(expected, result);
	}
	
	@Test
	public void testSingleByteToBooleanArrayAllTrue() {
		var expected = new boolean[] { true, true, true, true, true, true, true, true };
		var result = JdbcTools.toBooleanArray(new byte[] { (byte) 0xff });
		assertArrayEquals(expected, result);
	}
	
	@Test
	public void testSingleByteToBooleanArrayMixedValues() {
		var expected = new boolean[] { false, true, true, true, false, true, false, true };
		var result = JdbcTools.toBooleanArray(new byte[] { 0b01110101 });
		assertArrayEquals(expected, result);
	}
	
	@Test
	public void testDoubleByteToBooleanArrayAllFalse() {
		var expected = new boolean[] { false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false };
		var result = JdbcTools.toBooleanArray(new byte[] { 0x00, 0x00 });
		assertArrayEquals(expected, result);
	}
	
	@Test
	public void testDoubleByteToBooleanArrayAllTrue() {
		var expected = new boolean[] { true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true };
		var result = JdbcTools.toBooleanArray(new byte[] { (byte) 0xff, (byte) 0xff });
		assertArrayEquals(expected, result);
	}
	
	@Test
	public void testDoubleByteToBooleanArrayMixedValues() {
		var expected = new boolean[] { false, true, false, true, false, true, true, true, false, true, false, true, true, true, false, true };
		var result = JdbcTools.toBooleanArray(new byte[] { 0b01010111, 0b01011101 });
		assertArrayEquals(expected, result);
	}
