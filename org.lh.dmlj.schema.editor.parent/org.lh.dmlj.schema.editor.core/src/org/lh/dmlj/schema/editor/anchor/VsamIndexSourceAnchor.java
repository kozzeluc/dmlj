...
public class VsamIndexSourceAnchor extends AbstractConnectionAnchor {
	...
	/**
	 * Constructs a VsamIndexSourceAnchor with the given VSAM index figure.
	 * @param figure The source (owner) index figure
	 */
	public VsamIndexSourceAnchor(VsamIndexFigure vsamIndexFigure) {
		super(vsamIndexFigure);
	}

	/** 
	 * This method will always return the VSAM index figure's bottom center point.
