...
public class ElementCommentListQueryTemplateTest extends AbstractQueryTestCase {
	...
	public void test_10_dbkeys_grouped_by_3() {		
		...
		assertEquals(toLines(new File("testdata/ExpectedElementCommentListQuery_10_3.txt")), 
					 toLines(sql));		
	}
	...
	public void test_1_dbkey_grouped_by_3() {		
		...
		Dictionary dictionary = getDictionary("SYSDICT", 3);
		String sql = template.generate(new Object[] {dictionary, dbkeyProviders});		
		assertEquals(toLines(new File("testdata/ExpectedElementCommentListQuery_1_3.txt")), 
					 toLines(sql));		
	}
