...
public class CalcKeyElementListQueryTemplate implements IQueryTemplate {
  ...
  protected final String TEXT_17 = " AND" + NL + "      \"S-SRCD\" AND SRCD_113.SR_ID_113 > 9 AND SRCD_113.MODE_113 = 1 AND" + NL + "      FIRST \"SRCD-SAM\" AND" + NL + "      \"SRCD-SMR\" AND SMR_052.SET_NAM_052 = 'CALC' AND" + NL + "      \"SMR-SCR\"";
