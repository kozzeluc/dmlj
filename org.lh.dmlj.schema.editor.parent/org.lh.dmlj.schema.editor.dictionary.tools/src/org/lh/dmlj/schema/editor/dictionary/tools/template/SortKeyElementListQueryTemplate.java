...
public class SortKeyElementListQueryTemplate implements IQueryTemplate {
  ...
  protected final String TEXT_8 = " AND" + NL + "      \"S-SRCD\" AND SRCD_113.SR_ID_113 > 9 AND" + NL + "      FIRST \"SRCD-SAM\" AND" + NL + "      \"SRCD-SMR\" AND SMR_052.SET_NAM_052 <> 'CALC' AND" + NL + "      \"SMR-SCR\"";
