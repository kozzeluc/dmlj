...
public class ValidSchemaListForNonSysdirlDictionariesQueryTemplate implements IQueryTemplate {
  ...
  protected final String TEXT_4 = "\".\"OOAK-012\",  " + NL + "\t \"";
  protected final String TEXT_5 = "\".\"S-010\"" + NL + "WHERE OOAK_KEY_012 = 'OOAK' AND " + NL + "      \"OOAK-S\" AND S_NAM_010 <> 'NON IDMS' AND ERR_010 = 0" + NL + "ORDER BY S_NAM_010, S_SER_010 ";
