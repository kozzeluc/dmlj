...
public class PostOptionsPagesExtensionElement extends AbstractExtensionElement {
	
	private List<DataEntryPageExtensionElement> dataEntryPageExtensionElements;	

	public PostOptionsPagesExtensionElement(IConfigurationElement configElement) {
		super(configElement);		
	}
